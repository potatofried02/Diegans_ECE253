...
<<<<<<< HEAD
Specular Glare: Caused by strong directional lighting or flash.

Uneven Illumination: Resulting from shadows or poor lighting conditions.

Motion Blur: Caused by camera shake or hand movement.
...
3.  **Prepare Datasets:**
    ...
    -   _Note: Ensure data is placed in the `./data` directory._
